...
def compute_distance_old(src, tar, index):
	'''
...
def compute_distance(src, tar, index = None): #np.loadtxt('/raid/jzh/FeatureDistangle/src/front_part_v.txt', dtype=int)
	'''
	compute the L2 distance of average distance between 2 meshes on each vertice
	'''
	src_mesh = om.read_trimesh(src)
...
def cal_distance_in_file(src_file_format, tar_file_format, vis = False):
    avg_dis=[]
    index=np.loadtxt('/raid/jzh/FeatureDistangle/src/front_part_v.txt',dtype=int)
...
if __name__ == '__main__':
    #print(compute_distance_old('/home/jzh/mesh/result_id.obj', '/home/jzh/mesh/target_id.obj', None)[0])
    #print(compute_distance_old('/home/jzh/mesh/start_id.obj', '/home/jzh/mesh/target_id.obj', None)[0])
    # align interpolation result
#     data_root='/raid/jzh/FeatureDistangle/data/xyz/Interpolated_results'
#     for j in range(141, 151):
#         for i in range(47):
#             print('processing {} mesh'.format(i))
#    #         write_align_mesh('/raid/jzh/FeatureDistangle/data/xyz/Interpolated_results/interpolated_{}.obj'.format(i),\
#    #                          '/raid/jzh/FeatureDistangle/data/distangle/Mean_Face.obj'\
#    #                          ,'/raid/jzh/FeatureDistangle/data/xyz/Interpolated_results/aligned_interpolated_{}.obj'.format(i), None)
#             write_align_mesh('/raid/jzh/meshes_1115/mesh_final_final/bp_rec/Feature{}/{}.obj'.format(j, i),\
#                              '/raid/jzh/align_warehouse_all/Tester_{}/face_{}.obj'.format(j, i)\
#                              ,'/raid/jzh/meshes_1115/mesh_final_final/bp_rec/Feature{}/aligned_{}.obj'.format(j,i), None)
    avg_dis=[]
    count=0
    meshpath_root = '/home/jzh/coma_mesh'#/raid/jzh/FeatureDistangle/data/mesh/'
    test_root = '/home/jzh/coma_mesh'#/raid/jzh/FeatureDistangle/data/mesh/'
    ...
    for i in range(12):
        for j in range(1,len(os.listdir(os.path.join(meshpath_root,'ori/Feature{}/'.format(i))))):
            ...
            #print(src_path)
            #print(tar_path)
            dis,_,_ = compute_distance_old(src_path, tar_path, index)
            avg_dis.append(dis)
            print('Loading Mesh: {}, Expression: {}, vertice distacnce: {}'.format(i,j, dis))
            count=count+1
...
#    test_root = '/home/jzh/mesh'#'/raid/jzh/SVD_TestData/Reconstruct_data_trainingpose_1018'#mesh_gcn_fc_fusion_training_pose,mesh_fcfc+,
...
#            #src_path=os.path.join(meshpath_root,'Reconstruct_data','Tester_'+str(i),'face_'+str(j)+'_reconstruct.obj')
#            src_path=os.path.join(test_root,'rec_fusion/Feature{}/{}.obj'.format(i,j))#'Tester_{}/pose_{}_reconstruct.obj
#            #print(src_path)
#            #print(tar_path)
...
#    count=0
#    meshpath_root = '/home/jzh/coma_mesh'#/raid/jzh/FeatureDistangle/data/mesh/'
#    test_root = '/home/jzh/coma_mesh'#'/home/jzh/mesh_coma_data_1'#/raid/jzh/FeatureDistangle/data/mesh/'
#    
#    index=None
#    for i in range(12):
#        for j in range(1,len(os.listdir(os.path.join(meshpath_root,'ori/Feature{}/'.format(i))))):
...
#        print('No.:{} ,distance:{}'.format(exp_id, compute_distance('/home/jzh/mesh/id_distangle_{}_aligned.obj'.format(exp_id), '/raid/jzh/align_warehouse_all/Tester_{}/face_0.obj'.format(exp_id), index)[0]))
#    for i in range(47):
#        print(compute_distance('/raid/jzh/FeatureDistangle/data/mesh/bp_plus/Feature142/{}.obj'.format(i), '/raid/jzh/FeatureDistangle/data/mesh/ori/Feature142/{}.obj'.format(i), None)[0])
...
#    print(compute_distance('mesh/plus_distangle_{}.obj'.format(exp_id), 'mesh/rec_distangle_{}.obj'.format(exp_id), index)[0])
